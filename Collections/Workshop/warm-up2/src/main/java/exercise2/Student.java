...
public class Student {
    ...
    public String toString() {
        return "Id:" + this.getId() + " First Name: " + this.getFirstName() + " Last Name: "
                + this.getLastName() +" Average Grade: " + this.getAverageGrade();
    }
        ...
        if(this.getId().equals(s.getId()))
            if(this.getLastName().equals(s.getLastName()))
                if(this.getFirstName().equals(s.getFirstName()))
                    if(this.getAverageGrade().equals(s.getAverageGrade()))
                        return true;
    ...
    public int hashCode() {
        ...
        return (this.getId() * 2) + (this.getFirstName().length() * 3)
                + (this.getLastName().length() * 5) + (this.getAverageGrade().intValue() * 2);
